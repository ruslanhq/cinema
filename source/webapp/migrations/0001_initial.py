# Generated by Django 3.0 on 2020-07-15 14:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='webapp.Actor', verbose_name='актеры')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='webapp.Actor', verbose_name='режисер')),
                ('genre', models.ManyToManyField(to='webapp.Genre', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Фильм',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.Movie', verbose_name='фильм')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='webapp.Reviews', verbose_name='Родитель')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.Movie', verbose_name='фильм')),
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.RatingStar', verbose_name='звезда')),
            ],
            options={
